...
These findings affirm the pivotal role of feature scaling in deep learning
 models applied to financial time series. The inclusion of extended-hour trading introduces greater
 distributional variability and elevates the importance of robust normalization strategies. In this
 context, the Robust scaler demonstrates consistent advantages in balancing accuracy and loss,
 positioning it as a default choice for models ingesting full-session equity data. However, the notable
 performance of NoScaler on ETFs and highly liquid instruments suggests that in some scenarios,
 the preservation of raw feature distributions can retain signal characteristics otherwise obscured
 by transformation.
 To enhance generalization across diverse asset classes and volatility regimes, future research should
 explore the integration of adaptive preprocessing strategies. These could involve dynamically select
ing or parameterizing scaling methods based on real-time diagnostics. Such frameworks would allow for more intelligent, asset-aware pipelines capable
 of maintaining optimal performance in dynamic and multifactorial financial environments.
